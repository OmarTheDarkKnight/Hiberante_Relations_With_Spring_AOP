...
public class UniqueConstraintValidator implements ConstraintValidator<Exists, String> {
    ...
    public boolean isValid(String value, ConstraintValidatorContext constraintValidatorContext) {
        return value != null && annotationService.unique(tableName, columnName, value);
    }
}
